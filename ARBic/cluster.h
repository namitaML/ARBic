...
extern void test_print(FILE *fw, Block *b, int num);// new lxy
...
int get_Genes_LCS(const discrete *s1, const discrete *s2,char *lcs_tg,std::vector<int>&a);
...
int most_repeat(std::vector<int>a);
bits16 **profile;
#endif
